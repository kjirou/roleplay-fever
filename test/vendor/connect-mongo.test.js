...
//
// Copy from connect-mongo v0.6:
//
//   https://github.com/kcbanner/connect-mongo/tree/0479473ee4856c8b28ae7ff7f847deba882582cc
//
...
// !
// mongodb が必要なテストは、詳細不明だが落ちるし、別途 mongodb も入れないとだし、除外した
...
// !
// "deprecated defaultExpirationTime option is deprecated." が出るので実行対象から外した
...
// !
describe('connect-mongo vendor', function(){
  Object.keys(exports).forEach(function(testName){
    it(testName, exports[testName]);
  });
});
